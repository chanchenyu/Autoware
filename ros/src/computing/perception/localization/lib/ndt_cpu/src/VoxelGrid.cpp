...
<<<<<<< HEAD:ros/src/computing/perception/localization/lib/fast_pcl/ndt_cpu/src/VoxelGrid.cpp
<<<<<<< HEAD
	points_per_voxel_.reset();
...
=======
	points_per_voxel_.reset();
	points_per_voxel_ = boost::make_shared<std::vector<int> >(voxel_num_, 0);
>>>>>>> 37b76fce43ae4c19ef2133beab914ca1b1b1e859:ros/src/computing/perception/localization/lib/ndt_cpu/src/VoxelGrid.cpp
