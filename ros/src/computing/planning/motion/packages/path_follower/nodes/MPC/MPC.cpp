...
namespace vlr {
    ...
    MPCController::MPCController() : nh_(), received_applanix_state_(false),received_trajectory_(false), 
        ...
        if (sim_flag){
            controller_target_pub_  = nh_.advertise<path_follower_msgs::ControllerTarget>("ControllerTarget_sim", 1);
            steering_pub_ = nh_.advertise<dbw_mkz_msgs::SteeringCmd>("path_follower/steering_cmd_sim",1);
            twist_pub_ = nh_.advertise<geometry_msgs::TwistStamped>("twist_cmd_sim", 1);
            ...
            time_pub_ = nh_.advertise<path_follower_msgs::MpcTime>("Time_sim",30);
            ...
            steering_pub_ = nh_.advertise<dbw_mkz_msgs::SteeringCmd>("path_follower/steering_cmd",5);
            ...
            time_pub_ = nh_.advertise<path_follower_msgs::MpcTime>("Time",30);
    ...
    void MPCController::getDesiredStates() {
        ...
        // path_follower_msgs::TrajectoryPoint2D *p1, *p2;
        double dt = 1.0 / p_hertz;
