...
geometry_msgs::PoseStamped actual_pose_a;
geometry_msgs::Point initial_position;
geometry_msgs::Point current_position;
geometry_msgs::Pose2D current_pose_2D;
path_follower::TwistStamped actual_vel;
...
void UTMCallback(const geometry_msgs::PoseStamped::ConstPtr& msg)
{
  ...
  actual_pose.header.stamp = msg->header.stamp;
  /*
  actual_pose_a.pose.position.x = (current_position.x-558600)/10;
  actual_pose_a.pose.position.y = (current_position.y-4196600)/100;
  actual_pose_a.pose.position.z =  current_position.z;
  */
  if (initial_read == 0)
  {
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher pub1 = n.advertise<path_follower::TwistStamped>("current_twist",1); 
...
//ros::Publisher pub4 = n.advertise<geometry_msgs::PoseStamped>("current_pose_a",1);
...
/*
      actual_pose_a.pose.orientation.x = initial_orientation.x();
      actual_pose_a.pose.orientation.y = initial_orientation.y();
      actual_pose_a.pose.orientation.z = initial_orientation.z();
      actual_pose_a.pose.orientation.w = initial_orientation.w();
      actual_pose_a.header.frame_id="base_link";*/
